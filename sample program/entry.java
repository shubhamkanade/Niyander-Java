...
class MarvellousLogin extends Template implements ActionListener,Runnable
{
	...
	public boolean Validate(String Username,String password)
	{
		...
		if((password.matches(arr)) && (Username.length()<8))
		return true;
		else 
		return false;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==SUBMIT)
		{
			...
			if(value1.equals("MarvellousAdmin") && value2.equals(arr))
			{
			...
			else
			{
				...
				if(attemp==0)
				{
					 JOptionPane.showMessageDialog(this,"Number of attemps finished","Marvellous-packr-unpacker",JOptionPane.ERROR_MESSAGE);
				this.dispose();
				System.exit(0);
